...
Pod::Spec.new do |s|
  s.name             = 'HyperioniOS'
  s.version          = '0.1.0'
  s.summary          = 'A short description of HyperioniOS.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/chrsmys/HyperioniOS'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'chrsmys' => 'chris.mays@willowtreeapps.com' }
  s.source           = { :git => 'https://github.com/chrsmys/HyperioniOS.git', :tag => s.version.to_s }
